...
public class CraftSheep extends CraftMob implements Sheep {

    protected final net.minecraft.world.entity.animal.Sheep sheepHandle;

    public CraftSheep(net.minecraft.world.entity.animal.Sheep handle) {
        super(handle);
        this.sheepHandle = handle;
    }

    public net.minecraft.world.entity.animal.Sheep getSheepHandle() {
        return sheepHandle;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CraftSheep other)) return false;
    ...
    public String toString() {
        return "CraftSheep{id=" + getEntityId() + "}";
    }
}
