...
public class CraftWitch extends CraftMob implements Witch {

    protected final net.minecraft.world.entity.monster.Witch witchHandle;

    public CraftWitch(net.minecraft.world.entity.monster.Witch handle) {
        super(handle);
        this.witchHandle = handle;
    }

    public net.minecraft.world.entity.monster.Witch getWitchHandle() {
        return witchHandle;
    }
    ...
    @Override
    public boolean isDrinkingPotion() { return false; }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CraftWitch other)) return false;
    ...
    public String toString() {
        return "CraftWitch{id=" + getEntityId() + "}";
    }
}
