...
public class CraftInventoryFurnace extends CraftInventory implements FurnaceInventory {
    ...
    public CraftInventoryFurnace(Container container) {
        super(container);
    }

    @Override
    public ItemStack getResult() { return getItem(2); }

    @Override
    public ItemStack getFuel() { return getItem(1); }

    @Override
    public ItemStack getSmelting() { return getItem(0); }
    ...
    @Override
    public Furnace getHolder() { return null; }
}
